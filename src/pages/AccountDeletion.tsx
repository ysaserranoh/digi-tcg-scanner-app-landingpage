    ...
    >
      ...
      <Container maxWidth="md" sx={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          ...
          >
            Request deletion of your Digi TCG Scan account and associated data
          </Typography>
          ...
          <Box sx={{ color: 'rgba(255, 255, 255, 0.9)', fontFamily: 'Montserrat' }}>
            ...
            <Typography paragraph>
              At Digi TCG Scan, we respect your privacy and your right to control your personal data. You can request the deletion of your account and all associated personal data at any time.
            </Typography>
            ...
            <Typography paragraph>
              You have two options to request account deletion:
            </Typography>
            ...
            <Typography component="ol" sx={{ pl: 3, mb: 3 }}>
              ...
              <li>Your account and all data will be deleted immediately</li>
            </Typography>
            ...
            >
              ...
              <Button
                variant="contained"
                href="mailto:contact@digitcgscan.app?subject=Account Deletion Request&body=I would like to delete my Digi TCG Scan account and all associated data.%0D%0A%0D%0AEmail associated with my account: [Your Email]%0D%0AReason (optional): "
                sx={{
                  mt: 2,
                  bgcolor: '#5B4B8A',
                  color: 'white',
            ...
            <Typography paragraph>
              - <strong>In-app deletion:</strong> Immediate (account deleted instantly)
            </Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
              If you have any questions about the account deletion process or data retention, please contact us at:
            </Typography>
            <Typography paragraph>
